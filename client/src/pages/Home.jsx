...
const Home = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://static.augnito.ai/static/media/our-expertise.0b432cefb4fe3ab0cba3.webp")',
      }}
    >
      {loading && <Spinner />}
      <Header />
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 lg:px-16">
        ...
        <div className="flex flex-col justify-start items-start max-w-4xl">
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            Speech Recognition made easy with Voice AI
          </h1>
          <p className="text-lg text-white mb-8">
            Our Model enables effortless medical workflows via Automatic Speech
